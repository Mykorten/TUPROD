            ...
            <div className="relative z-0 flex items-center justify-center space-x-4">
                {videos.map((video) => {
                    return (
                        ...
                        >
                            <video
                                className={`object-cover w-full project-layout-video ${allVideosLoaded ? "opacity-100" : "opacity-0"} transition duration-500 ${hoveredTitle !== video.src ? 'blur-sm' : 'blur-none'}`} 

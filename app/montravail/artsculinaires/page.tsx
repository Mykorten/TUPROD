...
const videos = [
    ...
    { src: "JAFARBOEUF1.mp4", legende: "COTE DE BOEUF DE GALLICE" },
    { src: "JAFARBOEUF2.mp4", legende: "ENTRECOTE DE BOEUF DE GALLICE" },
    { src: "JAFARVELOUTE.mp4", legende: "VELOUTE DE COURGE" },
];
            ...
            <div className="relative z-0 space-x-4 flex flex-row items-center bg-black">
                <div className="video-container container mx-auto relative  h-auto">
                    <video className="object-cover" autoPlay muted loop>
                        <source src={`${CLOUD_SOURCE}/PUBADRIEN.mp4`} type="video/mp4" />
                    </video>
